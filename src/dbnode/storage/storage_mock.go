...
// Source: /Users/richardartoul/gocode/src/github.com/m3db/m3db/src/dbnode/storage/types.go
...
import (
	...
	clock "github.com/m3db/m3db/src/dbnode/clock"
	encoding "github.com/m3db/m3db/src/dbnode/encoding"
	persist "github.com/m3db/m3db/src/dbnode/persist"
	commitlog "github.com/m3db/m3db/src/dbnode/persist/fs/commitlog"
	runtime "github.com/m3db/m3db/src/dbnode/runtime"
	sharding "github.com/m3db/m3db/src/dbnode/sharding"
	block "github.com/m3db/m3db/src/dbnode/storage/block"
	bootstrap "github.com/m3db/m3db/src/dbnode/storage/bootstrap"
	result "github.com/m3db/m3db/src/dbnode/storage/bootstrap/result"
	index "github.com/m3db/m3db/src/dbnode/storage/index"
	namespace "github.com/m3db/m3db/src/dbnode/storage/namespace"
	repair "github.com/m3db/m3db/src/dbnode/storage/repair"
	series "github.com/m3db/m3db/src/dbnode/storage/series"
	xcounter "github.com/m3db/m3db/src/dbnode/x/xcounter"
	xio "github.com/m3db/m3db/src/dbnode/x/xio"
	segment "github.com/m3db/m3ninx/index/segment"
	context "github.com/m3db/m3x/context"
	ident "github.com/m3db/m3x/ident"
...
func (m *MockDatabase) Write(ctx context.Context, namespace, id ident.ID, timestamp time0.Time, value float64, unit time.Unit, annotation []byte) error {
...
func (m *MockDatabase) WriteTagged(ctx context.Context, namespace, id ident.ID, tags ident.TagIterator, timestamp time0.Time, value float64, unit time.Unit, annotation []byte) error {
...
func (m *MockDatabase) ReadEncoded(ctx context.Context, namespace, id ident.ID, start, end time0.Time) ([][]xio.BlockReader, error) {
...
func (m *MockDatabase) FetchBlocks(ctx context.Context, namespace ident.ID, shard uint32, id ident.ID, starts []time0.Time) ([]block.FetchBlockResult, error) {
...
func (m *MockDatabase) FetchBlocksMetadata(ctx context.Context, namespace ident.ID, shard uint32, start, end time0.Time, limit, pageToken int64, opts block.FetchBlocksMetadataOptions) (block.FetchBlocksMetadataResults, *int64, error) {
...
func (m *MockDatabase) FetchBlocksMetadataV2(ctx context.Context, namespace ident.ID, shard uint32, start, end time0.Time, limit int64, pageToken PageToken, opts block.FetchBlocksMetadataOptions) (block.FetchBlocksMetadataResults, PageToken, error) {
...
// Write mocks base method
func (m *MockdatabaseNamespace) Write(ctx context.Context, id ident.ID, timestamp time0.Time, value float64, unit time.Unit, annotation []byte) error {
...
// WriteTagged mocks base method
func (m *MockdatabaseNamespace) WriteTagged(ctx context.Context, id ident.ID, tags ident.TagIterator, timestamp time0.Time, value float64, unit time.Unit, annotation []byte) error {
...
// ReadEncoded mocks base method
func (m *MockdatabaseNamespace) ReadEncoded(ctx context.Context, id ident.ID, start, end time0.Time) ([][]xio.BlockReader, error) {
...
// FetchBlocks mocks base method
func (m *MockdatabaseNamespace) FetchBlocks(ctx context.Context, shardID uint32, id ident.ID, starts []time0.Time) ([]block.FetchBlockResult, error) {
...
// FetchBlocksMetadata mocks base method
func (m *MockdatabaseNamespace) FetchBlocksMetadata(ctx context.Context, shardID uint32, start, end time0.Time, limit, pageToken int64, opts block.FetchBlocksMetadataOptions) (block.FetchBlocksMetadataResults, *int64, error) {
...
// FetchBlocksMetadataV2 mocks base method
func (m *MockdatabaseNamespace) FetchBlocksMetadataV2(ctx context.Context, shardID uint32, start, end time0.Time, limit int64, pageToken PageToken, opts block.FetchBlocksMetadataOptions) (block.FetchBlocksMetadataResults, PageToken, error) {
...
// Bootstrap mocks base method
func (m *MockdatabaseNamespace) Bootstrap(start time0.Time, process bootstrap.Process) error {
...
func (m *MockdatabaseNamespace) Flush(blockStart time0.Time, ShardBootstrapStates ShardBootstrapStates, flush persist.DataFlush) error {
...
func (m *MockdatabaseNamespace) FlushIndex(tickStart time0.Time, flush persist.IndexFlush) error {
...
func (m *MockdatabaseNamespace) Snapshot(blockStart, snapshotTime time0.Time, flush persist.DataFlush) error {
...
func (m *MockdatabaseNamespace) NeedsFlush(alignedInclusiveStart, alignedInclusiveEnd time0.Time) bool {
...
// Repair mocks base method
func (m *MockdatabaseNamespace) Repair(repairer databaseShardRepairer, tr time.Range) error {
...
func (m *MockdatabaseShard) OnEvictedFromWiredList(id ident.ID, blockStart time0.Time) {
...
// Write mocks base method
func (m *MockdatabaseShard) Write(ctx context.Context, id ident.ID, timestamp time0.Time, value float64, unit time.Unit, annotation []byte) error {
	ret := m.ctrl.Call(m, "Write", ctx, id, timestamp, value, unit, annotation)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// WriteTagged mocks base method
func (m *MockdatabaseShard) WriteTagged(ctx context.Context, id ident.ID, tags ident.TagIterator, timestamp time0.Time, value float64, unit time.Unit, annotation []byte) error {
	ret := m.ctrl.Call(m, "WriteTagged", ctx, id, tags, timestamp, value, unit, annotation)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// ReadEncoded mocks base method
func (m *MockdatabaseShard) ReadEncoded(ctx context.Context, id ident.ID, start, end time0.Time) ([][]xio.BlockReader, error) {
	ret := m.ctrl.Call(m, "ReadEncoded", ctx, id, start, end)
	ret0, _ := ret[0].([][]xio.BlockReader)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// FetchBlocks mocks base method
func (m *MockdatabaseShard) FetchBlocks(ctx context.Context, id ident.ID, starts []time0.Time) ([]block.FetchBlockResult, error) {
...
// FetchBlocksMetadata mocks base method
func (m *MockdatabaseShard) FetchBlocksMetadata(ctx context.Context, start, end time0.Time, limit, pageToken int64, opts block.FetchBlocksMetadataOptions) (block.FetchBlocksMetadataResults, *int64, error) {
...
// FetchBlocksMetadataV2 mocks base method
func (m *MockdatabaseShard) FetchBlocksMetadataV2(ctx context.Context, start, end time0.Time, limit int64, pageToken PageToken, opts block.FetchBlocksMetadataOptions) (block.FetchBlocksMetadataResults, PageToken, error) {
...
// Flush mocks base method
func (m *MockdatabaseShard) Flush(blockStart time0.Time, flush persist.DataFlush) error {
...
// Snapshot mocks base method
func (m *MockdatabaseShard) Snapshot(blockStart, snapshotStart time0.Time, flush persist.DataFlush) error {
...
func (m *MockdatabaseShard) FlushState(blockStart time0.Time) fileOpState {
...
func (m *MockdatabaseShard) SnapshotState() (bool, time0.Time) {
...
func (m *MockdatabaseShard) CleanupSnapshots(earliestToRetain time0.Time) error {
...
func (m *MockdatabaseShard) CleanupExpiredFileSets(earliestToRetain time0.Time) error {
...
// Repair mocks base method
func (m *MockdatabaseShard) Repair(ctx context.Context, tr time.Range, repairer databaseShardRepairer) (repair.MetadataComparisonResult, error) {
...
func (m *MocknamespaceIndex) BlockStartForWriteTime(writeTime time0.Time) time.UnixNano {
...
func (m *MocknamespaceIndex) ReplaceBlock(blockStart time0.Time, segments []segment.Segment) error {
...
// CleanupExpiredFileSets mocks base method
func (m *MocknamespaceIndex) CleanupExpiredFileSets(t time0.Time) error {
...
// Flush mocks base method
func (m *MockdatabaseFlushManager) Flush(tickStart time0.Time, dbBootstrapStateAtTickStart DatabaseBootstrapState) error {
...
func (m *MockdatabaseCleanupManager) Cleanup(t time0.Time) error {
...
// Cleanup mocks base method
func (m *MockdatabaseFileSystemManager) Cleanup(t time0.Time) error {
	ret := m.ctrl.Call(m, "Cleanup", t)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// Flush mocks base method
func (m *MockdatabaseFileSystemManager) Flush(t time0.Time, dbBootstrapStateAtTickStart DatabaseBootstrapState) error {
...
func (m *MockdatabaseFileSystemManager) Run(t time0.Time, dbBootstrapStateAtTickStart DatabaseBootstrapState, runType runType, forceType forceType) bool {
...
// Repair mocks base method
func (m *MockdatabaseShardRepairer) Repair(ctx context.Context, namespace ident.ID, tr time.Range, shard databaseShard) (repair.MetadataComparisonResult, error) {
...
func (m *MockOptions) SetErrorWindowForLoad(value time0.Duration) Options {
...
func (m *MockOptions) ErrorWindowForLoad() time0.Duration {
...
func (m *MockOptions) SetMinimumSnapshotInterval(value time0.Duration) Options {
...
func (m *MockOptions) MinimumSnapshotInterval() time0.Duration {
